...
## It first checks the existence of matrix inverse. If so, it retrives the value from the cache
## & skips the computation. Otherwise, it calls setInv() to compute matrix inverse and set value in cache.
